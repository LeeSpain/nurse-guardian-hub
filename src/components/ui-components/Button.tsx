...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'rounded-lg font-medium transition-all duration-200 flex items-center justify-center shadow-button focus:outline-none focus:ring-2 focus:ring-offset-2';
  ...
  const variantClasses = {
    ...
    nurse: 'bg-nurse text-nurse-foreground hover:bg-nurse/90 focus:ring-nurse/50',
