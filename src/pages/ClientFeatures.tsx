  ...
  return (
    <>
      <PageHero
        ...
        subtitle="NurseSync provides you with the tools to manage your health and stay connected with your healthcare providers, no matter where you are."
        badge="For Care Recipients & Families"
        badgeColor="client"
        image="/placeholder.svg"
      >
