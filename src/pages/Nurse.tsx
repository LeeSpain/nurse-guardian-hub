                ...
                <div className="flex flex-col md:flex-row items-center">
                  ...
                  <div className="md:w-1/2 md:pl-16 text-left">
                    ...
                    <p className="text-gray-600">
                      ...
                      ensuring compatibility from the start for a successful relationship.
                    </p>
                  </div>
                </div>
              </Transition>
              ...
              <Transition animation="fade-up" delay="delay-300">
                <div className="flex flex-col md:flex-row items-center">
                  <div className="md:w-1/2 md:pr-16 mb-8 md:mb-0 text-right">
                    ...
                    <h3 className="text-2xl font-bold mb-3">Free Intro Calls</h3>
                    <p className="text-gray-600">
                      Connect with potential clients through free 15-minute video calls to discuss needs 
                      and assess fit before committing to ongoing care.
                    </p>
                  </div>
                  <div className="md:w-16 relative">
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 md:static md:transform-none">
              ...
              <Transition animation="fade-up" delay="delay-400">
                <div className="flex flex-col md:flex-row items-center">
                  ...
                  <div className="md:w-1/2 md:pl-16 text-left">
                    ...
                    <h3 className="text-2xl font-bold mb-3">Care Seeker Commitment</h3>
                    <p className="text-gray-600">
                      Care seekers confirm their choice via a legally binding agreement, committing 
                      to pay for your ongoing professional services.
                    </p>
                  </div>
                </div>
              </Transition>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <Transition animation="fade-up">
            <div className="text-center mb-16">
              <div className="inline-flex items-center bg-purple-100 rounded-full px-3 py-1 mb-4">
                ...
                <span className="text-purple-700 font-medium text-sm">Pricing Plans</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Flexible Plans for Every Stage</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Free Plan */}
            <Transition animation="fade-up" delay="delay-100">
              <Card className="border border-purple-100 hover:border-purple-300 transition-all duration-300 hover:shadow-xl overflow-hidden relative">
                ...
                <CardContent className="p-6">
                  <div className="mb-4">
                    ...
                    <p className="text-gray-600 text-sm">Perfect for nurses who are just getting started with remote care.</p>
                  </div>
                  
                  <div className="space-y-3 my-6">
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-purple-600 mr-2 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Manage up to 2 active clients</span>
                    </div>
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-purple-600 mr-2 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Basic AI documentation tools</span>
                    </div>
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-purple-600 mr-2 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">HD HIPAA-compliant video calls</span>
                    </div>
                  </div>
            ...
            {/* Growth Plan */}
            <Transition animation="fade-up" delay="delay-200">
              <Card className="border border-purple-300 hover:border-purple-400 transition-all duration-300 shadow-lg hover:shadow-xl overflow-hidden relative">
                ...
                <CardContent className="p-6">
                  <div className="mb-4">
                    ...
                    <div className="mt-2 mb-4">
                      ...
                      <span className="text-gray-500 ml-1">/month</span>
                      <span className="block text-sm text-purple-600 font-medium">+ 20% commission</span>
                    </div>
                    <p className="text-gray-600 text-sm">Low upfront cost with revenue tied to your earnings.</p>
                  </div>
                  
                  <div className="space-y-3 my-6">
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-purple-600 mr-2 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Manage up to 10 active clients</span>
                    </div>
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-purple-600 mr-2 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Smart matching + active outreach</span>
                    </div>
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-purple-600 mr-2 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Full invoicing system</span>
                    </div>
                  </div>
              ...
              <Card className="border border-purple-100 hover:border-purple-300 transition-all duration-300 hover:shadow-xl overflow-hidden relative">
                ...
                <CardContent className="p-6">
                  <div className="mb-4">
                    ...
                    <p className="text-gray-600 text-sm">Full suite of tools for scaling your practice.</p>
                  </div>
                  
                  <div className="space-y-3 my-6">
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-purple-600 mr-2 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Unlimited active clients</span>
                    </div>
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-purple-600 mr-2 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Advanced AI documentation</span>
                    </div>
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-purple-600 mr-2 flex-shrink-0 mt-0.5" />
          ...
          <div className="max-w-4xl mx-auto text-center">
            <Transition animation="fade-up">
              <div className="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-white font-medium">Join 5,000+ healthcare professionals</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">Ready to Transform Your Practice?</h2>
              <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
                Start delivering exceptional remote care and grow your income with Nurse-Sync.
              </p>
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                <Button
                  variant="secondary"
                  size="lg"
                  className="bg-white hover:bg-gray-100 text-purple-700 shadow-xl"
                  to="/login"
                >
